...
const CreateTrueFalse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const quizData = {
            title,
            type: "truefalse",  // Change for other types accordingly
    ...
    return (
        ...
        >
            <h1 className="text-2xl font-bold mb-4">Create True/False Quiz</h1>
            <form onSubmit={handleSubmit} className="bg-slate p-6 rounded-lg shadow-md w-1/2">
                ...
                {questions.map((q, qIndex) => (
                    <div key={qIndex} className="mb-4 border p-4 rounded bg-gray-50">
                        ...
                        <select value={q.correctAnswer} onChange={(e) => handleCorrectAnswerChange(qIndex, e.target.value)}
